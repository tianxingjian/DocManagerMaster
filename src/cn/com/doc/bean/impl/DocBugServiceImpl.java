...
public class DocBugServiceImpl extends BaseDao<DocBugmessage, String>
  implements IDocBugService
{
  ...
  public String calrealPath(String bugIds, List<String> fileFileName, DocBugmessage freeBugMsg)
  {
  ...
  private String excutecalSimrealPath(String bugId, List<String> fileName, DocBugmessage freeBugMsg)
  {
    boolean isdel = deleteById(bugId);
    String relPath = MD5.Md(freeBugMsg.getProductName() + freeBugMsg.getProjectName(), false);
  ...
  private String excutecalComrealPath(String[] bugIds, List<String> fileName, DocBugmessage freeBugMsg) {
    String relPath = MD5.Md(freeBugMsg.getProductName() + freeBugMsg.getProjectName(), false);
    return relPath;
  }

  public Set<String> getFilePaths(String bugId, String rootDir) throws Exception
  {
    DocBugmessage bugmsg = (DocBugmessage)get(bugId);
    if ((bugmsg == null) || (StringUtils.isBlank(bugmsg.getBugId())) || (bugmsg.getDocPatchs() == null)) {
